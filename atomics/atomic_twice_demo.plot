...
# ./build/atomics/atomic_twice_demo > mutex_cnt.dat
# ./build/atomics/atomic_twice_demo -atomic=1 > atomic_cnt.dat
#
# run plotter with
# > gnuplot -persist -c ./atomics/atomic_twice_demo.plot
#
#------------------------------------------------------------------------------
#
...
set output "atomic_twice_demo.png"
